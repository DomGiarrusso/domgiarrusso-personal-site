...
export default function Navbar({}: Props) {
  ...
  return (
    <nav
      className={`w-full flex justify-center bg-background border-b border-b-foreground/10 h-16 sticky top-0 transition-all z-50 text-lg  ${isScrolled ? 'bg-background/80 backdrop-blur-md shadow-md' : 'bg-background border-b-transparent'}`}
    >
